...
const ProjectCard = ({ project, className = '' }) => {
  ...
  return (
    ...
    >
      ...
      {/* Project Content */}
      <div className="p-6">
        <h3 className="text-xl font-bold text-slate-100 mb-2 group-hover:text-blue-400 transition-colors duration-300">
          {project.title}
        </h3>
          ...
          <div className="flex space-x-3">
            {project.liveUrl && (
              <motion.button
                ...
                className="flex items-center space-x-1 text-blue-400 hover:text-blue-300 text-sm font-medium transition-colors duration-200"
            ...
            {project.githubUrl && (
              <motion.button
                ...
                className="flex items-center space-x-1 text-slate-400 hover:text-slate-300 text-sm font-medium transition-colors duration-200"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
