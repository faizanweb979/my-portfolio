      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <motion.a
            ...
            className="inline-flex items-center space-x-2 px-8 py-4 bg-slate-800/80 hover:bg-slate-700/80 border border-slate-600/50 hover:border-slate-500/50 rounded-xl text-slate-200 font-semibold transition-all duration-300"
